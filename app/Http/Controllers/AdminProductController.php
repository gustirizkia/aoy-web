<?php namespace App\Http\Controllers;
	...
	class AdminProductController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Cara Pakai','name'=>'cara_pakai','type'=>'wysiwyg','validation'=>'required|string|min:5|max:5000','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Khasiat','name'=>'khasiat','type'=>'wysiwyg','validation'=>'required|string|min:5|max:5000','width'=>'col-sm-10'];
       ...
       {
           return DB::table('produks')->select('slug')->where('slug', 'like', $slug.'%')
           ->where('id', '<>', $id)
           ->get();
       }
