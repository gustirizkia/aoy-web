<?php namespace App\Http\Controllers;
	...
	class AdminPagesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Body','name'=>'body','type'=>'wysiwyg','validation'=>'required|string|min:5','width'=>'col-sm-10','help'=>'Tipe file yang didukung: JPG, JPEG, PNG, GIF, BMP'];
			...
			//$this->form[] = ['label'=>'Page','name'=>'page','type'=>'text','validation'=>'required|min:1|','width'=>'col-sm-10'];
			# OLD END FORM
	    ...
	    */
	    public function hook_before_add(&$postdata) {
	        //Your code here
            DB::table('pages')->where("page", "tentang")->delete();
            $postdata['page'] = "tentang";
            $postdata['uuid'] = "P-010";
	    }
