                ...
                <div class="sidebar-heading text-center">
                    <div class="d-flex justify-content-center">
                        <div class="position-relative">
                            ...
                            <img :src="imgStore" alt="" class="mt-4 logo__image_edit cursor-pointer"
                                @click="$refs.imageStore.click()" />
                            <input type="file" accept="image/*" name="image" x-ref="imageStore" class="d-none"
                                @change="onChangeImageStore">
                            <div class="text-sm text-secondary cursor-pointer" @click="$refs.imageStore.click()">Klik untuk
                                update</div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-md-12">
                                <div class="mt-4">
                                    ...
                                    <input type="text" class="form-control" name="akun_ig"
                                        value="{{ $member->akun_ig }}">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="mt-4">
                                    <label for="">Nomor WhatsApp Toko</label>
                                    <input type="number" class="form-control" name="nomor_wa"
                                        value="{{ $member->nomor_wa }}">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-7">
                        <div class="mt-2">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <input type="text" class="form-control mt-2" name="jalan"
                                        placeholder="alamat jalan" value="{{ $member->jalan }}">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="mt-4">
                            <div class="row">
                                @foreach ($gallery as $item)
                                    <div class="col-md-3 col-6 mb-3">
                                        <div class="position-relative">
                                            ...
                                            <a href="{{ route('deleteImage') }}?id={{ $item->id }}"
                                                class="delete_image px-1">X</a>
                                        </div>
                                    </div>
                                @endforeach
                                ...
                                <div class="col-md-3 col-6 mb-3 position-relative">
                                    <img src="{{ asset('gambar/add-image.png') }}" class="img-fluid" alt=""
                                        @click="$refs.imageRef.click()">
                                    <input type="file" accept="image/*" x-ref="imageRef" class="d-none"
                                        @change="onFileChange">
