        ...
        <div class="md:flex justify-between items-center">
            ...
            <div class="md:flex mt-4 md:mt-0">
                <div class="flex group group-focus::border-primary bg-white group-focus:ring-primary py-1 focus-within:ring-primary focus-within:border-primary border-2 rounded-full w-full md:w-60 items-center px-3">
                    ...
                    <select id="province_id" x-model="province_id" class="w-full text-sm text-gray-900 bg-gray-50 focus:ring-0 border-0 placeholder-gray-400">
                        <option value="0" class="text-gray-400">Semua Provinsi</option>
                ...
                <div class="flex group group-focus::border-primary bg-white mt-4 md:mt-0 md:ml-8 group-focus:ring-primary py-1 focus-within:ring-primary focus-within:border-primary border-2 rounded-full w-full md:w-60 items-center px-3">
                    ...
                    <input type="text" class="w-full text-sm text-gray-900 bg-gray-50 focus:ring-0 border-0 placeholder-gray-400" placeholder="Cari Nama atau ID" x-model="username" @input.debounce.350ms="fetchResults">
                </div>
            </div>
        </div>

        <div class="my-10 grid grid-flow-row grid-cols-12 gap-6 md:gap-10" id="members_tag">
        ...
        return{
            ...
            fetchResults(){
                ...
                axios.get('{{ route('member-filter') }}?username='+this.username)
                            .then(res => {
                                let tagMember= '';
                                console.log('res username', res.data.data.data);
